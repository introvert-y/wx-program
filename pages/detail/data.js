const areaMap = {
  ...
  华北: {
    include: ['不限', '北京', '天津', '山西', '河北', '内蒙古'],
  },
  华东: {
    include: ['不限', '上海', '江苏', '浙江', '安徽', '福建', '江西', '山东', '台湾'],
  },
  华南: {
    include: ['不限', '广东', '海南', '广西', '香港', '澳门'],
  },
  西北: {
    include: ['不限', '山西', '甘肃', '青海', '宁夏', '新疆'],
  },
  东北: {
    include: ['不限', '黑龙江', '吉林', '辽宁'],
  },
  西南: {
    include: ['不限', '重庆', '四川', '贵州', '云南', '西藏'],
  },
  海外: {
    include: ['不限'],
  },
